...
btn4 = Button(f2_padx=16,pady=16, bd=4, fg="white", font=('arial' ,20, 'bold'), text="4", bg="black", command=lambda: btnclick(4)) 
btn4.grid(row=3, column=0)

btn5 = Button(f2_padx=16,pady=16, bd=4, fg="white", font=('arial' ,20, 'bold'), text="5", bg="black", command=lambda: btnclick(5)) 
btn4.grid(row=5, column=1)

btn6 = Button(f2_padx=16,pady=16, bd=4, fg="white", font=('arial' ,20, 'bold'), text="6", bg="black", command=lambda: btnclick(6)) 
...
btn2 = Button (f2_padx=16,pady=16, bd=4, fg="white", font=('arial' 20, 'bold'), text="2", bg="black", command-lambda: btnclick(2)) 
btn1.grid(row=4, column=1)

btn3 = Button(f2_padx=16,pady=16, bd=4, fg="white", font=('arial' 20, 'bold'), text="3", bg="black", command-lambda: btnclick(3)) 
